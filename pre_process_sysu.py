...
data_path = 'E:\\wj-lab\\super-resolution-master\\save_img\\part1vdsr'
root_path = 'E:\\wj-lab\\data\\SYSU RGB-IR Re-ID\\'
...
print("files_rgb:", files_rgb)
print("files_ir:",files_ir )
# relabel
pid_container = set()
...
np.save(root_path + 'train_rgb_resized_img.npy', train_img)
np.save(root_path + 'train_rgb_resized_label.npy', train_label)

# ir imges
train_img, train_label = read_imgs(files_ir)
np.save(root_path + 'train_ir_resized_img.npy', train_img)
np.save(root_path + 'train_ir_resized_label.npy', train_label)
